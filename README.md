...
The project is structured as a three-stage pipeline. Each notebook is self-contained, GitHub-renderable, and hands off its outputs to the next through the `artifacts/` folder:
...
|---|---|---|
| [`01_data_preparation.ipynb`](01_data_preparation.ipynb) | [README](01_data_preparation_README.md) | ~2–3 min |
| [`02_model_training.ipynb`](02_model_training.ipynb) | [README](02_model_training_README.md) | ~15–40 min |
| [`03_interactive_annexes.ipynb`](03_interactive_annexes.ipynb) | [README](03_interactive_annexes_README.md) | seconds (servers stay alive) |
...
![AnnexB](<img width="431" height="885" alt="image" src="https://github.com/user-attachments/assets/ff1d270c-531b-4962-aeee-a2d2bfbebcb2" />)

**"Ask the Project" AI Assistant**

![AnnexC](<img width="713" height="519" alt="image" src="https://github.com/user-attachments/assets/70bb5708-4e21-42a8-9722-398fa5f8a7ac" />)
...
│
├── artifacts/                         # Pipeline handoff (not tracked by Git)
...
│
├── 05_05_images/                            # Figures generated by the notebooks
│
...
# Competition data and pipeline artifacts (regenerable)
train_test_data/
artifacts/
...
Main challenges identified (full detail in [Part 1's README](01_data_preparation_README.md)):
...
Full detail in [Part 2's README](02_model_training_README.md).
...
Full detail in [Part 3's README](03_interactive_annexes_README.md). Three local web interfaces make the results usable by non-technical stakeholders — and the live predictor imports the exact `feature_pipeline.py` generated in Part 1, guaranteeing prediction consistency with the trained models.
...
Annexes A and C (notebook 03) require an Anthropic API key. Create a `.env` file in the project root:
...
2. Place the competition CSVs in `train_test_data/`
3. Keep `ib_style.py` in the repo root (optional — notebooks fall back to default styling)
4. Run the notebooks **in order**:
   1. `01_data_preparation.ipynb` — produces `artifacts/` and `feature_pipeline.py`
